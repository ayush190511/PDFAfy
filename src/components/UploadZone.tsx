        ...
        <div className="space-y-6">
          ...
          <div
            ...
            className={`w-full p-8 sm:p-12 rounded-2xl border-2 border-dashed transition-all duration-200 cursor-pointer text-center relative overflow-hidden group ${
              isDragging
                ? 'border-[#171717] dark:border-[#f5f5f5] bg-[#fafafa] dark:bg-[#171717] ring-4 ring-[#171717]/10 dark:ring-white/10'
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center space-y-4 relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-[#fafafa] dark:bg-[#171717] border border-[#ebebeb] dark:border-[#262626] flex items-center justify-center text-[#171717] dark:text-[#f5f5f5] group-hover:scale-110 group-hover:bg-[#171717] dark:group-hover:bg-[#f5f5f5] group-hover:text-white dark:group-hover:text-[#0a0a0a] transition-all shadow-xs">
                <Upload className="w-7 h-7" />
              </div>

              <div className="space-y-1">
                <h3 className="text-lg font-semibold text-[#171717] dark:text-[#f5f5f5] tracking-tight">
                  Drag & Drop your PDF here, or <span className="underline decoration-1 underline-offset-4 font-medium text-[#0070f3]">browse</span>
                </h3>
                <p className="text-xs text-[#888888] dark:text-[#a3a3a3]">
                  Supports large files up to 150MB • ISO 19005 Compliant Output
                </p>
              </div>

              {/* Badges */}
              <div className="flex flex-wrap items-center justify-center gap-2 pt-2 text-[11px] font-mono text-[#888888] dark:text-[#a3a3a3]">
                <span className="flex items-center gap-1 bg-[#fafafa] dark:bg-[#171717] px-2.5 py-1 rounded-full border border-[#ebebeb] dark:border-[#262626]">
                ...
                <span className="flex items-center gap-1 bg-[#fafafa] dark:bg-[#171717] px-2.5 py-1 rounded-full border border-[#ebebeb] dark:border-[#262626]">
                  <FileText className="w-3 h-3 text-[#171717] dark:text-[#f5f5f5]" />
